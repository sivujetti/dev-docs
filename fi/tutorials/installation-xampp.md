...
<span class="bg-highlight">Asenna</span> oletussisältö komennolla `php backend/cli.php install-from-dir basic-site sivujettiuser user@email.com userpass - - - - /hello-sivujetti/`
{: .dm-macos }
...
<span class="bg-highlight">Asenna</span> oletussisältö komennolla `c:\xampp\php\php.exe backend\cli.php install-from-dir basic-site sivujettiuser user@email.com userpass - - - - /hello-sivujetti/`
{: .dm-windows .d-none }
...
<span class="bg-highlight">Aja komento</span> `php backend/cli.php install-from-dir basic-site sivujettiuser user@email.com userpass mysql hellosivujetti root root /hello-sivujetti/`
{: .dm-macos }

Mikäli terminaali sanoo että `command not found: php`, aja komento `alias php='/Applications/MAMP/bin/php/php8.0.0/bin/php'` ja yritä sitten uudelleen.
{: .message-box.info .dm-macos data-title="Info" }

<span class="bg-highlight">Aja komento</span> `c:\xampp\php\php.exe backend\cli.php install-from-dir basic-site sivujettiuser user@email.com userpass mysql hellosivujetti root - /hello-sivujetti/`
{: .dm-windows .d-none }
